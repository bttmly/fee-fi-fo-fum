...
// ceejbot/fivebeans aliases "delete" as "destroy", but it's not really necessary.
// but we should support both anyway
{
  const delCmd = makeCommand("delete", "DELETED");
  BeanstalkdClient.prototype.destroy = delCmd;
  BeanstalkdClient.prototype.delete = delCmd;
}
